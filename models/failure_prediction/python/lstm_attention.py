...
Original file is located at
    https://colab.research.google.com/drive/1uqyjB5Ltcs_yVTFBvl7HMBRvifkEOGdn
...
INPUT_DIM = 100
TIME_STEPS = 20
# if True, the attention vector is shared across the input_dimensions
# where the attention is applied.
...
def attention_3d_block(hidden_states):
    ...
    hidden_states_t = Reshape(
        (hidden_size, TIME_STEPS), name='attention_input_reshape')(hidden_states_t)
    # Inside dense layer
...
plot_model(
    single_step_model,
    to_file='/content/drive/MyDrive/LFN Anuket/Analysis/data/Final/LSTM-Attention-B.png',
    show_shapes=True,
